    ...
    <div class="row d-flex mx-auto" >
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 mb-sm-4" id="pub-desktop">
            <div class="col-12">
                ...
                <div class="title-card-content outcard-title mt-4 mb-4" id="pubs-title-mobile">Publicações</div>
                ...
                <div class="card mb-2">
                    ...
                    <img src="https://picsum.photos/720/1280?random=1" class="foto-post">
                ...
                <div class="card mb-2">
                    ...
                    <img src="https://picsum.photos/720/1280?random=2" class="foto-post">
